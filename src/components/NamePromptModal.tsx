...
export default function NamePromptModal({ onSubmit }: NamePromptModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 font-body">
      <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-md mx-4">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={!name.trim()}
            className="w-full px-4 py-3 text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed font-semibold shadow-lg shadow-indigo-600/30"
          >
            Join Session
          </button>
        </form>
